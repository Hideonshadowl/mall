        ...
        <section v-show="!isLoading">
          <section class="shopcart-page">
              ...
              <div class="shopcart-item" v-for="item in cartProductVoList" data-type="0">
                <div class="shopcart-item-box" @touchstart.capture="touchStart" @touchend.capture="touchEnd">
                  <div class="shopcart-item-select">
                    <i class='iconfont icon-duigou' data-selected="1" v-show="item.a===true"
                          @click="item.a=!item.a"></i>
                    <i class='iconfont icon-weibiaoti38' data-selected="0" @click="item.a=!item.a"></i>
                  </div>
                  <img src="../../assets/product.gif" v-if="item"/>
                  <img src="../../assets/product_default.jpg" v-else/>
                  <div class="shopcart-item-info">
                    <p class="shopcart-name" v-text="item"></p>
                    <p class="shopcart-subtitle" v-text="item"></p>
                    <div class="shopcart-num">
                      <span class="shopcart-price" v-text="`￥${88}`"></span>
                      <div class="shopcart-quantity">
                        <el-button style="position: relative;top:-2rem;right: -1.8rem;font-size: 0.4rem" @click="deletegood(item)">删除</el-button>
            ...
            <div class="shopcart-footer" v-if="cartProductVoList.length > 0">
              <div class="shopcart-item-select" >
                <i class="iconfont icon-duigou" v-if="allChecked === true" @click="cancelselect()"></i>
                <i class="iconfont icon-weibiaoti38"  v-else @click="allchose()"></i>
                <span @click="allchose()">全选</span>
              </div>
    ...
    export default {
        data() {
            return {
                changestyle:'',
                imageHost: '',
                cartProductVoList: [{'a':true},{'a':true},{'a':true},{'a':true},{'a':true}],
                recommendList: [],
                cartTotalPrice: 0,
                allChecked: false,
                startX: 0,
        ...
        methods: {
          ...
          deletegood(item){ this.cartProductVoList.pop(item)},
          h(item){
              item=''
              console.log(item)
            },
          allchose(){this.cartProductVoList.forEach(ele=>ele.a=true)
                     this.allChecked=true
          },
          cancelselect(){this.cartProductVoList.forEach(ele=>ele.a=false)
